...
def find_WSJ_equity_growth(tick):
    url = f'https://www.wsj.com/market-data/quotes/ISRG/financials/annual/balance-sheet'
    ...
    growth_rate = calculate_growth_rate(target_processed[0], target_processed[-1], len(target_processed) - 1)
    return growth_rate
